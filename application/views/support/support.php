...
<html lang="en">
    <head>
        ...
        <style> 
            ...
            .topnav a:hover {
                border-bottom: 3px solid #318D8C;
            }
                                ...
                                <div class="inbox_msg filters_style">
                                    ...
                                    <div class="headind_srch">
                                        <?php 
                                            ...
                                            if($tabClass == 'archived'){

                                                $archivedClass="active";
                                                $allClass="";
                                            }else{
                                        ...
                                        <div class="topnav" style="width:75%">
                                            <a class="<?php echo $allClass;?>" style="width:25%"  href="<?php echo base_url();?>index.php/admin/Support/index?ticket=all">All</a>
                                            <a class="<?php echo $archivedClass;?>" style="width:25%" href="<?php echo base_url();?>index.php/admin/Support/index?ticket=archived">Archived</a>
                                        </div>
                                    </div>
                                    <div class="inbox_people" style="height: 840px;overflow-y: auto;">
                                        <div class="inbox_chat">
                                            ...
                                            <?php foreach($tickets as $ticket) { ?>
                                                <?php
                                                    if( empty($ticket['userData'][0]['profile_image']) ){

                                                        $imageSource = "https://ptetutorials.com/images/user-profile.png";
                                                    }else{

                                                        $imageSource = $ticket['userData'][0]['profile_image'];
                                                    }
                                                        ...
                                                        <td>
                                                            <div class="chat_list"> 
                                                                ...
                                                                <div class="chat_people">
                                                                    ...
                                                                    <div class="chat_ib">
                                                                        <h5><?php echo $ticket['userData'][0]['full_name']; ?> <span class="chat_date"><?php echo $last_time_ago; ?></span></h5>
                                ...
                                <div class="mesgs">
                                    ...
                                    <div class="type_msg" id = "messageReply">
                                        <div class="input_msg_write" style="display: flex">
                                            ...
                                            <textarea type="text" style="margin-left:10%" class="write_msg form-control textarea-control filters_style" placeholder="Type your message..." id="sendMessage"></textarea>
