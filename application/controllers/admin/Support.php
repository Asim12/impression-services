...
class Support extends CI_Controller {
    ...
    public function index(){
        ...
        if($this->input->get('ticket') == 'archived'){

        $search['status'] = 'archived';
        $this->session->set_userdata('tab', 'archived');
        }else{

        $this->session->set_userdata('tab', 'All');
        $search['status']['$in'] = ['read', 'achrived', 'new', 'pending', 'completed'];
        }
